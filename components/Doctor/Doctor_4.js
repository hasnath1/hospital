...
const Doctor = ({
  ...
  return (
    <div className="p-[22px] pt-[18px] max-w-[260px] rounded-[5px] shadow-3xl flex flex-col items-center m-8">
      ...
      <h1 className="text-xl text-[#333333] font-semibold w-max mt-2">
        {name}
      </h1>
      ...
      {/*Social Media Icons  */}
      <div className="grid grid-cols-3 gap-x-5 my-2">
      ...
      <p className="text-[#333333] text-[12px] leading-5 mt-2 mb-4 text-center">
        {info.length >= 90 ? `${info.substr(0, 90)}...` : info}
      </p>
